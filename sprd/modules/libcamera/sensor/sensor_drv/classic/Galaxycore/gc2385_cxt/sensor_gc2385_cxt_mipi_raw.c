...
#define LOG_TAG "gc2385_cxt_mipi_raw"
#include "sensor_gc2385_cxt_mipi_raw.h"
...
static void gc2385_cxt_drv_write_gain(cmr_handle handle, cmr_u32 gain) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc2385_cxt_drv_write_frame_length(cmr_handle handle,
                                          cmr_u32 frame_len) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void gc2385_cxt_drv_write_shutter(cmr_handle handle, cmr_u32 shutter) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 *============================================================================*/
static cmr_int gc2385_cxt_update_exposure(cmr_handle handle, cmr_u32 shutter,
    ...
    if (dest_fr_len != cur_fr_len) {
        ...
        gc2385_cxt_drv_write_frame_length(handle, dest_fr_len);
    }
write_sensor_shutter:
    /* write shutter to sensor registers */
    sns_drv_cxt->sensor_ev_info.preview_shutter = shutter;
    gc2385_cxt_drv_write_shutter(handle, shutter);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int gc2385_cxt_drv_power_on(cmr_handle handle, cmr_uint power_on) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    ...
    BOOLEAN power_down = g_gc2385_cxt_mipi_raw_info.power_down_level;
    BOOLEAN reset_level = g_gc2385_cxt_mipi_raw_info.reset_pulse_level;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int gc2385_cxt_drv_init_fps_info(cmr_handle handle) {
...
static cmr_int gc2385_cxt_drv_get_static_info(cmr_handle handle, cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
    ...
    if (!fps_info->is_init) {
        gc2385_cxt_drv_init_fps_info(handle);
    }
    ...
    ex_info->name = (cmr_s8 *)g_gc2385_cxt_mipi_raw_info.name;
    ex_info->sensor_version_info =
        (cmr_s8 *)g_gc2385_cxt_mipi_raw_info.sensor_version_info;
...
static cmr_int gc2385_cxt_drv_get_fps_info(cmr_handle handle, cmr_u32 *param) {
    cmr_int rtn = SENSOR_SUCCESS;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int gc2385_cxt_drv_access_val(cmr_handle handle, cmr_uint param) {
    ...
    SENSOR_LOGI("sensor gc2385_cxt: param_ptr->type=%x", param_ptr->type);

    switch (param_ptr->type) {
    case SENSOR_VAL_TYPE_GET_STATIC_INFO:
        ret = gc2385_cxt_drv_get_static_info(handle, param_ptr->pval);
        break;
    case SENSOR_VAL_TYPE_GET_FPS_INFO:
        ret = gc2385_cxt_drv_get_fps_info(handle, param_ptr->pval);
        break;
    case SENSOR_VAL_TYPE_SET_SENSOR_CLOSE_FLAG:
        ret = sns_drv_cxt->is_sensor_close = 1;
        break;
    case SENSOR_VAL_TYPE_GET_PDAF_INFO:
        // ret = gc2385_cxt_drv_get_pdaf_info(handle, param_ptr->pval);
        break;
    default:
        break;
    }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int gc2385_cxt_drv_identify(cmr_handle handle, cmr_uint param) {
    ...
    pid_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, GC2385_CXT_PID_ADDR);

    if (GC2385_CXT_PID_VALUE == pid_value) {
        ver_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, GC2385_CXT_VER_ADDR);
        SENSOR_LOGI("Identify: pid_value = %x, ver_value = %x", pid_value,
                    ver_value);
        if (GC2385_CXT_VER_VALUE == ver_value) {
            SENSOR_LOGI("this is gc2385_cxt sensor");
 ...
 *============================================================================*/
static cmr_int gc2385_cxt_drv_before_snapshot(cmr_handle handle, cmr_uint param) {
    ...
    cap_shutter = gc2385_cxt_update_exposure(handle, cap_shutter, 0, 0);
    cap_gain = prv_gain;
    gc2385_cxt_drv_write_gain(handle, cap_gain);
 ...
 *============================================================================*/
static cmr_int gc2385_cxt_drv_write_exposure(cmr_handle handle, cmr_uint param) {
    ...
    ret_value =
        gc2385_cxt_update_exposure(handle, exposure_line, dummy_line, size_index);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int gc2385_cxt_drv_write_gain_value(cmr_handle handle, cmr_uint param) {
    ...
    gc2385_cxt_drv_write_gain(handle, real_gain);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int gc2385_cxt_drv_stream_on(cmr_handle handle, cmr_uint param) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt *sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int gc2385_cxt_drv_stream_off(cmr_handle handle, cmr_uint param) {
    SENSOR_LOGI("E");
...
static cmr_int
gc2385_cxt_drv_handle_create(struct sensor_ic_drv_init_para *init_param,
    ...
    sensor_ic_set_match_module_info(sns_drv_cxt,
                                    ARRAY_SIZE(s_gc2385_cxt_module_info_tab),
                                    s_gc2385_cxt_module_info_tab);
    sensor_ic_set_match_resolution_info(sns_drv_cxt,
                                        ARRAY_SIZE(s_gc2385_cxt_resolution_tab_raw),
                                        s_gc2385_cxt_resolution_tab_raw);
    sensor_ic_set_match_trim_info(sns_drv_cxt,
                                  ARRAY_SIZE(s_gc2385_cxt_resolution_trim_tab),
                                  s_gc2385_cxt_resolution_trim_tab);
    sensor_ic_set_match_static_info(
        sns_drv_cxt, ARRAY_SIZE(s_gc2385_cxt_static_info), s_gc2385_cxt_static_info);
    sensor_ic_set_match_fps_info(sns_drv_cxt,
                                 ARRAY_SIZE(s_gc2385_cxt_mode_fps_info),
                                 s_gc2385_cxt_mode_fps_info);

    /*init exif info,this will be deleted in the future*/
    gc2385_cxt_drv_init_fps_info(sns_drv_cxt);

    /*add private here*/
    return ret;
}

static cmr_int gc2385_cxt_drv_handle_delete(cmr_handle handle, void *param) {
    cmr_int ret = SENSOR_SUCCESS;
...
static cmr_int gc2385_cxt_drv_get_private_data(cmr_handle handle, cmr_uint cmd,
                                           void **param) {
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
 ...
 * .power = gc2385_cxt_power_on,
 *============================================================================*/
static struct sensor_ic_ops s_gc2385_cxt_ops_tab = {
    .create_handle = gc2385_cxt_drv_handle_create,
    .delete_handle = gc2385_cxt_drv_handle_delete,
    .get_data = gc2385_cxt_drv_get_private_data,
    /*---------------------------------------*/
    .power = gc2385_cxt_drv_power_on,
    .identify = gc2385_cxt_drv_identify,
    .ex_write_exp = gc2385_cxt_drv_write_exposure,
    .write_gain_value = gc2385_cxt_drv_write_gain_value,

    .ext_ops = {
            [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops = gc2385_cxt_drv_before_snapshot,
            [SENSOR_IOCTL_STREAM_ON].ops = gc2385_cxt_drv_stream_on,
            [SENSOR_IOCTL_STREAM_OFF].ops = gc2385_cxt_drv_stream_off,
            /* expand interface,if you want to add your sub cmd ,
             *  you can add it in enum {@SENSOR_IOCTL_VAL_TYPE}
             */
            [SENSOR_IOCTL_ACCESS_VAL].ops = gc2385_cxt_drv_access_val,
    }};
