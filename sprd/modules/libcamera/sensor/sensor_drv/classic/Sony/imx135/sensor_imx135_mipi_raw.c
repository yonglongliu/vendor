...
static void imx135_drv_write_reg2sensor(cmr_handle handle,struct sensor_i2c_reg_tab *reg_info){
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void imx135_drv_write_gain(struct sensor_aec_i2c_tag *aec_info, cmr_u32 gain)
{
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void imx135_drv_write_frame_length(struct sensor_aec_i2c_tag *aec_info, cmr_u32 frame_len){
   SENSOR_IC_CHECK_PTR_VOID(aec_info);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void imx135_drv_write_shutter(struct sensor_aec_i2c_tag *aec_info, cmr_u32 shutter){
	SENSOR_IC_CHECK_PTR_VOID(aec_info);
	cmr_u32 value = 0x00;
...
static void imx135_drv_calc_gain(cmr_handle handle,cmr_uint isp_gain, struct sensor_aec_i2c_tag *aec_info) {
	SENSOR_IC_CHECK_HANDLE_VOID(handle);
	struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int imx135_drv_get_static_info(cmr_handle handle, uint32_t *param) 
{
    ...
    ex_info->sensor_version_info = (cmr_s8 *)g_imx135_mipi_raw_info.sensor_version_info;
...
static cmr_int imx135_drv_before_snapshot(cmr_handle handle, cmr_uint param)
{
	...
	imx135_drv_calc_exposure(handle,cap_shutter,0,capture_mode,&imx135_aec_info);
...
static cmr_int imx135_drv_write_exposure(cmr_handle handle, cmr_uint param)
{
	...
	imx135_drv_calc_exposure(handle,exposure_line,dummy_line,size_index,&imx135_aec_info);
	imx135_drv_write_reg2sensor(handle,imx135_aec_info.frame_length);
	imx135_drv_write_reg2sensor(handle,imx135_aec_info.shutter);
...
static cmr_int imx135_drv_read_aec_info(cmr_handle handle,cmr_uint param) {
    ...
    imx135_drv_calc_exposure(handle, exposure_line, dummy_line, mode, &imx135_aec_info);
    imx135_drv_calc_gain(handle,info->gain, &imx135_aec_info);

    return ret_value;
}

static cmr_int imx135_drv_set_master_FrameSync(cmr_handle handle,cmr_uint param) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int imx135_drv_handle_create(struct sensor_ic_drv_init_para *init_param, cmr_handle* sns_ic_drv_handle) 
{
    ...
    sensor_ic_set_match_module_info(sns_drv_cxt, ARRAY_SIZE(s_imx135_module_info_tab), s_imx135_module_info_tab);
    sensor_ic_set_match_resolution_info(sns_drv_cxt, ARRAY_SIZE(s_imx135_resolution_tab_raw), s_imx135_resolution_tab_raw);
    sensor_ic_set_match_trim_info(sns_drv_cxt, ARRAY_SIZE(s_imx135_resolution_trim_tab), s_imx135_resolution_trim_tab);
    sensor_ic_set_match_static_info(sns_drv_cxt, ARRAY_SIZE(s_imx135_static_info), s_imx135_static_info);
    sensor_ic_set_match_fps_info(sns_drv_cxt, ARRAY_SIZE(s_imx135_mode_fps_info), s_imx135_mode_fps_info);
...
static cmr_int imx135_drv_get_private_data(cmr_handle handle, cmr_uint cmd, void**param)
{
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
