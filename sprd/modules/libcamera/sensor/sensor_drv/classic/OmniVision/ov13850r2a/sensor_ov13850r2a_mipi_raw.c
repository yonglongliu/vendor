...
static void ov13850r2a_drv_write_reg2sensor(cmr_handle handle,struct sensor_i2c_reg_tab *reg_info){
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void ov13850r2a_drv_write_gain(struct sensor_aec_i2c_tag *aec_info, cmr_u32 gain)
{
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void ov13850r2a_drv_write_frame_length(struct sensor_aec_i2c_tag *aec_info, cmr_u32 frame_len){
   SENSOR_IC_CHECK_PTR_VOID(aec_info);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void ov13850r2a_drv_write_shutter(struct sensor_aec_i2c_tag *aec_info, cmr_u32 shutter){
	SENSOR_IC_CHECK_PTR_VOID(aec_info);
	cmr_u32 value = 0x00;
...
static void ov13850r2a_drv_calc_gain(cmr_handle handle,cmr_uint isp_gain, struct sensor_aec_i2c_tag *aec_info) {
	SENSOR_IC_CHECK_HANDLE_VOID(handle);
	struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int ov13850r2a_drv_get_static_info(cmr_handle handle, uint32_t *param) 
{
    cmr_int rtn = SENSOR_SUCCESS;
    ...
    ex_info->sensor_version_info = (cmr_s8 *)g_ov13850r2a_mipi_raw_info.sensor_version_info;
...
static cmr_int ov13850r2a_drv_identify(cmr_handle handle, cmr_uint param)
{
	...
	if (ov13850r2a_PID_VALUE == pid_value) {
		ver_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, ov13850r2a_VER_ADDR);
		SENSOR_LOGI("Identify: pid_value = %x, ver_value = %x", pid_value, ver_value);
		if (ov13850r2a_VER_VALUE == ver_value) {
			cmr_u16 ver1_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, ov13850r2a_VER1_ADDR);
			if (ov13850r2a_VER1_VALUE == ver1_value) {
				
				SENSOR_PRINT("Identify: PID = %x, VER = %x, ver1=%x", pid_value, ver_value,ver1_value);
				SENSOR_PRINT_HIGH("this is ov13850r2a sensor");
			    //ov13850r2a_init_mode_fps_info(handle);
				//ov13850r2a_init_mode_fps_info(handle);
            	ret_value = SENSOR_SUCCESS;
			}else {
				SENSOR_LOGE("sensor identify fail, PID = %x, VER = %x, ver1=%x", pid_value, ver_value,ver1_value);
			}
 ...
 *============================================================================*/
static cmr_int ov13850r2a_drv_before_snapshot(cmr_handle handle, cmr_uint param)
{
	...
	ov13850r2a_drv_calc_exposure(handle,cap_shutter,0,capture_mode,&ov13850r2a_aec_info);
 ...
 *============================================================================*/
static cmr_int ov13850r2a_drv_write_exposure(cmr_handle handle, cmr_uint param)
{
	...
	ov13850r2a_drv_calc_exposure(handle,exposure_line,dummy_line,size_index,&ov13850r2a_aec_info);
	ov13850r2a_drv_write_reg2sensor(handle,ov13850r2a_aec_info.frame_length);
	ov13850r2a_drv_write_reg2sensor(handle,ov13850r2a_aec_info.shutter);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int ov13850r2a_drv_write_gain_value(cmr_handle handle, cmr_uint param)
{
	cmr_int ret_value = SENSOR_SUCCESS;
...
static cmr_int ov13850r2a_drv_read_aec_info(cmr_handle handle,cmr_uint param) {
    ...
    ov13850r2a_drv_calc_exposure(handle, exposure_line, dummy_line, mode, &ov13850r2a_aec_info);
    ov13850r2a_drv_calc_gain(handle,info->gain, &ov13850r2a_aec_info);

    return ret_value;
}

static cmr_int ov13850r2a_drv_set_master_FrameSync(cmr_handle handle,cmr_uint param) {
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
...
static cmr_int ov13850r2a_drv_handle_create(struct sensor_ic_drv_init_para *init_param, cmr_handle* sns_ic_drv_handle) 
{
    ...
    sensor_ic_set_match_module_info(sns_drv_cxt, ARRAY_SIZE(s_ov13850r2a_module_info_tab), s_ov13850r2a_module_info_tab);
    sensor_ic_set_match_resolution_info(sns_drv_cxt, ARRAY_SIZE(s_ov13850r2a_resolution_tab_raw), s_ov13850r2a_resolution_tab_raw);
    sensor_ic_set_match_trim_info(sns_drv_cxt, ARRAY_SIZE(s_ov13850r2a_resolution_trim_tab), s_ov13850r2a_resolution_trim_tab);
    sensor_ic_set_match_static_info(sns_drv_cxt, ARRAY_SIZE(s_ov13850r2a_static_info), s_ov13850r2a_static_info);
    sensor_ic_set_match_fps_info(sns_drv_cxt, ARRAY_SIZE(s_ov13850r2a_mode_fps_info), s_ov13850r2a_mode_fps_info);
...
static cmr_int ov13850r2a_drv_get_private_data(cmr_handle handle, cmr_uint cmd, void**param)
{
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
