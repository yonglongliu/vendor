...
//#define OTP_AUTO_LOAD_LSC_ov8856_lightarray

#define RG_TYPICAL_ov8856_lightarray     0x013F
#define BG_TYPICAL_ov8856_lightarray	    0x012C
#define R_TYPICAL_ov8856_lightarray		0x0000
#define G_TYPICAL_ov8856_lightarray		0x0000
#define B_TYPICAL_ov8856_lightarray		0x0000

static uint32_t ov8856_lightarray_read_otp_info(SENSOR_HW_HANDLE handle,void *param_ptr)
{
	uint32_t rtn = SENSOR_SUCCESS;
	struct otp_info_t *otp_info=(struct otp_info_t *)param_ptr;
	otp_info->rg_ratio_typical=RG_TYPICAL_ov8856_lightarray;
	otp_info->bg_ratio_typical=BG_TYPICAL_ov8856_lightarray;
	otp_info->r_typical=R_TYPICAL_ov8856_lightarray;
	otp_info->g_typical=G_TYPICAL_ov8856_lightarray;
	otp_info->b_typical=B_TYPICAL_ov8856_lightarray;
...
static uint32_t ov8856_lightarray_update_awb(SENSOR_HW_HANDLE handle,void *param_ptr)
{
	uint32_t rtn = SENSOR_SUCCESS;
	struct otp_info_t *otp_info=(struct otp_info_t *)param_ptr;
...
#ifndef OTP_AUTO_LOAD_LSC_ov8856_lightarray

static uint32_t ov8856_lightarray_update_lsc(SENSOR_HW_HANDLE handle,void *param_ptr)
{
	uint32_t rtn = SENSOR_SUCCESS;
	struct otp_info_t *otp_info=(struct otp_info_t *)param_ptr;
...
#endif
static uint32_t ov8856_lightarray_update_otp(SENSOR_HW_HANDLE handle,void *param_ptr)
{
	uint32_t rtn = SENSOR_SUCCESS;
	struct otp_info_t *otp_info=(struct otp_info_t *)param_ptr;

	rtn=ov8856_lightarray_update_awb(handle,param_ptr);
	...
	rtn=ov8856_lightarray_update_lsc(handle,param_ptr);
	if(rtn!=SENSOR_SUCCESS)
	{
...
static uint32_t ov8856_lightarray_identify_otp(SENSOR_HW_HANDLE handle,void *param_ptr)
{
	uint32_t rtn = SENSOR_SUCCESS;

	rtn=ov8856_lightarray_read_otp_info(handle,param_ptr);
