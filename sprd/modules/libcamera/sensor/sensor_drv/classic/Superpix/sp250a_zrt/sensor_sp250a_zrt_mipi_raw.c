...
#define LOG_TAG "9850ka_sp250a_zrt" 

#include "sensor_sp250a_zrt_mipi_raw.h"
#define FPS_INFO       s_sp250a_zrt_mode_fps_info
#define STATIC_INFO    s_sp250a_zrt_static_info
#define VIDEO_INFO     s_sp250a_zrt_video_info
#define MODULE_INFO    s_sp250a_zrt_module_info_tab
#define RES_TAB_RAW    s_sp250a_zrt_resolution_tab_raw
#define RES_TRIM_TAB   s_sp250a_zrt_resolution_trim_tab
#define MIPI_RAW_INFO  g_sp250a_zrt_mipi_raw_info
 ...
 *============================================================================*/
static void sp250a_zrt_drv_group_hold_on(cmr_handle handle) {
    SENSOR_LOGI("E");
}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void sp250a_zrt_drv_group_hold_off(cmr_handle handle) {
    SENSOR_LOGI("E");
}
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void sp250a_zrt_drv_write_gain(cmr_handle handle, cmr_u32 gain) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u16 sp250a_zrt_drv_read_frame_length(cmr_handle handle) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void sp250a_zrt_drv_write_frame_length(cmr_handle handle,
                                       cmr_u32 frame_len) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_u32 sp250a_zrt_drv_read_shutter(cmr_handle handle) {
    cmr_u32 value = 0x00;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static void sp250a_zrt_drv_write_shutter(cmr_handle handle, cmr_u32 shutter) {
    SENSOR_IC_CHECK_HANDLE_VOID(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
 ...
 *============================================================================*/
static cmr_int sp250a_zrt_drv_write_exposure_dummy(cmr_handle handle,
                                             cmr_u32 shutter,
                                             cmr_u32 dummy_line,
                                             cmr_u16 size_index) {
    ...
    // sp250a_zrt_group_hold_on(handle);
    ...
    cur_fr_len = sp250a_zrt_drv_read_frame_length(handle);

    if (shutter < SENSOR_MIN_SHUTTER)
        shutter = SENSOR_MIN_SHUTTER;

    if (dest_fr_len != cur_fr_len)
        sp250a_zrt_drv_write_frame_length(handle, dest_fr_len);
write_sensor_shutter:
    /* write shutter to sensor registers */
    sns_drv_cxt->sensor_ev_info.preview_shutter = shutter;

    sp250a_zrt_drv_write_shutter(handle, shutter);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp250a_zrt_drv_power_on(cmr_handle handle, cmr_uint power_on)
{
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
    ...
    BOOLEAN power_down = g_sp250a_zrt_mipi_raw_info.power_down_level;
    BOOLEAN reset_level = g_sp250a_zrt_mipi_raw_info.reset_pulse_level;	
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp250a_zrt_drv_init_fps_info(cmr_handle handle) 
{
...
static cmr_int sp250a_zrt_drv_get_static_info(cmr_handle handle, cmr_u32 *param) 
{
    cmr_int rtn = SENSOR_SUCCESS;
    ...
    if (!fps_info->is_init) {
        sp250a_zrt_drv_init_fps_info(handle);
    }
...
static cmr_int sp250a_zrt_drv_get_fps_info(cmr_handle handle, cmr_u32 *param) 
{
    cmr_int rtn = SENSOR_SUCCESS;
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp250a_zrt_drv_access_val(cmr_handle handle, cmr_uint param)
{
	...
	SENSOR_LOGI("sensor sp250a_zrt: param_ptr->type=%x", param_ptr->type);
	
	switch(param_ptr->type)
	{
		case SENSOR_VAL_TYPE_GET_STATIC_INFO:
			ret = sp250a_zrt_drv_get_static_info(handle, param_ptr->pval);
			break;
		case SENSOR_VAL_TYPE_GET_FPS_INFO:
			ret = sp250a_zrt_drv_get_fps_info(handle, param_ptr->pval);
			break;
		case SENSOR_VAL_TYPE_SET_SENSOR_CLOSE_FLAG:
			ret = sns_drv_cxt->is_sensor_close = 1;
			break;
		case SENSOR_VAL_TYPE_GET_PDAF_INFO:
			//ret = sp250a_zrt_drv_get_pdaf_info(handle, param_ptr->pval);
			break;
		default:
			break;
    }
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp250a_zrt_drv_identify(cmr_handle handle, cmr_uint param)
{
	...
	pid_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, sp250a_zrt_PID_ADDR);
	...
	if ((sp250a_zrt_PID_VALUE == pid_value) && ((id0 == 1) && (id1 == 0) &&(id2 ==0))) {
		ver_value = hw_sensor_read_reg(sns_drv_cxt->hw_handle, sp250a_zrt_VER_ADDR);
		SENSOR_LOGI("Identify: pid_value = %x, ver_value = %x", pid_value, ver_value);
		if (sp250a_zrt_VER_VALUE == ver_value) {
			SENSOR_LOGI("this is sp250a_zrt sensor");
 ...
 *============================================================================*/
static cmr_int sp250a_zrt_drv_before_snapshot(cmr_handle handle, cmr_uint param)
{
    ...
    cap_shutter = sp250a_zrt_drv_write_exposure_dummy(handle, cap_shutter, 0, 0);
    cap_gain = gain;
    sp250a_zrt_drv_write_gain(handle, cap_gain);
 ...
 *============================================================================*/
static cmr_int sp250a_zrt_drv_write_exposure(cmr_handle handle, cmr_uint param)
{
    ...
    ret_value = sp250a_zrt_drv_write_exposure_dummy(handle, exposure_line, dummy_line,
                                             size_index);
 ...
 * you can change this function if it's necessary
 *============================================================================*/
static cmr_int sp250a_zrt_drv_write_gain_value(cmr_handle handle, cmr_uint param)
{
	cmr_int ret_value = SENSOR_SUCCESS;
    cmr_u32 real_gain = 0;
    SENSOR_IC_CHECK_HANDLE(handle);
	...
	//sp250a_zrt_drv_calc_gain(handle,param,&sp250a_zrt_aec_info);
    ...
    sp250a_zrt_drv_write_gain(handle, real_gain);

	return ret_value;
}

static struct sensor_reg_tag sp250a_zrt_shutter_reg[] = {
 //   {0x3502, 0}, {0x3501, 0}, {0x3500, 0},
};

static struct sensor_i2c_reg_tab sp250a_zrt_shutter_tab = {
    .settings = sp250a_zrt_shutter_reg, .size = ARRAY_SIZE(sp250a_zrt_shutter_reg),
};

static struct sensor_reg_tag sp250a_zrt_again_reg[] = {
 //   {0x3208, 0x01}, {0x3508, 0x00}, {0x3509, 0x00},
};

static struct sensor_i2c_reg_tab sp250a_zrt_again_tab = {
    .settings = sp250a_zrt_again_reg, .size = ARRAY_SIZE(sp250a_zrt_again_reg),
};

static struct sensor_reg_tag sp250a_zrt_dgain_reg[] = {
 //   {0x5100, 0}, {0x5101, 0}, {0x5102, 0},    {0x5103, 0},
 //   {0x5104, 0}, {0x5105, 0}, {0x3208, 0x11}, {0x3208, 0xA1},
};

struct sensor_i2c_reg_tab sp250a_zrt_dgain_tab = {
    .settings = sp250a_zrt_dgain_reg, .size = ARRAY_SIZE(sp250a_zrt_dgain_reg),
};

static struct sensor_reg_tag sp250a_zrt_frame_length_reg[] = {
 //   {0x380e, 0}, {0x380f, 0},
};

static struct sensor_i2c_reg_tab sp250a_zrt_frame_length_tab = {
    .settings = sp250a_zrt_frame_length_reg,
    .size = ARRAY_SIZE(sp250a_zrt_frame_length_reg),
};
static struct sensor_aec_i2c_tag sp250a_zrt_aec_info = {
    .slave_addr = (I2C_SLAVE_ADDR >> 1),
    .addr_bits_type = SENSOR_I2C_REG_8BIT,
    .data_bits_type = SENSOR_I2C_VAL_8BIT,
    .shutter = &sp250a_zrt_shutter_tab,
    .again = &sp250a_zrt_again_tab,
    .dgain = &sp250a_zrt_dgain_tab,
    .frame_length = &sp250a_zrt_frame_length_tab,
};
static cmr_u16 sp250a_zrt_drv_calc_exposure(cmr_handle handle, cmr_u32 shutter,cmr_u32 dummy_line, 
...
static void sp250a_zrt_drv_calc_gain(float gain, struct sensor_aec_i2c_tag *aec_info) {
    float gain_a = gain;
    float gain_d = 0x400;
...
static cmr_int sp250a_zrt_drv_read_aec_info(cmr_handle handle,
                                           cmr_uint param) {
    cmr_int ret_value = SENSOR_SUCCESS;
    ...
    info->aec_i2c_info_out = &sp250a_zrt_aec_info;
...
//        sp250a_zrt_drv_get_default_frame_length(handle, mode);
//    s_current_default_line_time = s_sp250a_zrt_resolution_trim_tab[mode].line_time;
    sns_drv_cxt->line_time_def = sns_drv_cxt->trim_tab_info[mode].line_time;

    sns_drv_cxt->sensor_ev_info.preview_shutter = sp250a_zrt_drv_calc_exposure(
        handle, exposure_line, dummy_line, mode, &sp250a_zrt_aec_info);

    gain = info->gain < SENSOR_BASE_GAIN ? SENSOR_BASE_GAIN : info->gain;
    real_gain = (float)info->gain * SENSOR_BASE_GAIN / ISP_BASE_GAIN * 1.0;
    sp250a_zrt_drv_calc_gain(real_gain, &sp250a_zrt_aec_info);
    return ret_value;
}

cmr_int sp250a_zrt_drv_set_master_FrameSync(cmr_handle handle,
                                           cmr_uint param) {
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp250a_zrt_drv_stream_on(cmr_handle handle, cmr_uint param)
{
    SENSOR_IC_CHECK_HANDLE(handle);
    struct sensor_ic_drv_cxt * sns_drv_cxt = (struct sensor_ic_drv_cxt *)handle;
#if 1
    ...
    SENSOR_LOGI("E");
    //sp250a_zrt_drv_set_master_FrameSync(handle,param);
 ...
 * please modify this function acording your spec
 *============================================================================*/
static cmr_int sp250a_zrt_drv_stream_off(cmr_handle handle, cmr_uint param)
{
    SENSOR_LOGI("E");
    cmr_u8 value;
...
static cmr_int sp250a_zrt_drv_handle_create(struct sensor_ic_drv_init_para *init_param, cmr_handle* sns_ic_drv_handle) 
{
    ...
    sp250a_zrt_drv_init_fps_info(sns_drv_cxt);

    /*add private here*/
    return ret;
}

static cmr_int sp250a_zrt_drv_handle_delete(cmr_handle handle, void *param) 
{
    cmr_int ret = SENSOR_SUCCESS;
...
static cmr_int sp250a_zrt_drv_get_private_data(cmr_handle handle, cmr_uint cmd, void**param)
{
    cmr_int ret = SENSOR_SUCCESS;
    SENSOR_IC_CHECK_HANDLE(handle);
    SENSOR_IC_CHECK_PTR(param);
 ...
 * .power = sp250a_zrt_power_on,
 *============================================================================*/
static struct sensor_ic_ops s_sp250a_zrt_ops_tab = {
    .create_handle = sp250a_zrt_drv_handle_create,
    .delete_handle = sp250a_zrt_drv_handle_delete,
    .get_data = sp250a_zrt_drv_get_private_data,
/*---------------------------------------*/
	.power = sp250a_zrt_drv_power_on,
	.identify = sp250a_zrt_drv_identify,
	.ex_write_exp = sp250a_zrt_drv_write_exposure,
	.write_gain_value = sp250a_zrt_drv_write_gain_value,

    .ext_ops = {
        [SENSOR_IOCTL_BEFORE_SNAPSHOT].ops = sp250a_zrt_drv_before_snapshot,
        [SENSOR_IOCTL_STREAM_ON].ops = sp250a_zrt_drv_stream_on,
        [SENSOR_IOCTL_STREAM_OFF].ops = sp250a_zrt_drv_stream_off,
        /* expand interface,if you want to add your sub cmd ,
         *  you can add it in enum {@SENSOR_IOCTL_VAL_TYPE}
         */
        [SENSOR_IOCTL_ACCESS_VAL].ops = sp250a_zrt_drv_access_val,
    }
};
