...
static struct sensor_res_tab_info s_sp0a09_resolution_tab_raw[VENDOR_NUM] = {
    {.module_id = MODULE_SUNNY,
     .reg_tab = {{ADDR_AND_LEN_OF_ARRAY(sp0a09_init_setting), PNULL, 0,
...
static const SENSOR_REG_T
    s_sp0a09_preview_size_video_tab[SENSOR_VIDEO_MODE_MAX][1] = {
    /*video mode 0: ?fps*/
...
static const SENSOR_REG_T
    s_sp0a09_capture_size_video_tab[SENSOR_VIDEO_MODE_MAX][1] = {
    /*video mode 0: ?fps*/
    {{.reg_addr = 0xffff, .reg_value = 0xff}},
    /* video mode 1:?fps*/
    {{.reg_addr = 0xffff, .reg_value = 0xff}},
