 ...
 **/
#define LOG_TAG "ov8856_cmk_otp_drv"
#include <stdio.h>
#include <string.h>
#include <math.h>
#include <utils/Log.h>
...
#include "ov8856_cmk_golden_otp.h"
...
static cmr_int _ov8856_cmk_section_checksum(cmr_u8 *buf, cmr_uint first,
...
static cmr_int ov8856_cmk_otp_drv_read(cmr_handle otp_drv_handle, void *p_data);
...
otp_drv_entry_t ov8856_cmk_drv_entry = {
    .otp_cfg =
        {
            .cali_items =
                {
    ...
    .otp_ops =
        {
            .sensor_otp_create = ov8856_cmk_otp_drv_create,
            .sensor_otp_delete = ov8856_cmk_otp_drv_delete,
            .sensor_otp_read = ov8856_cmk_otp_drv_read,
            .sensor_otp_write = ov8856_cmk_otp_drv_write,
            .sensor_otp_parse = ov8856_cmk_otp_drv_parse,
            .sensor_otp_calibration = ov8856_cmk_otp_drv_calibration,
            .sensor_otp_ioctl = ov8856_cmk_otp_drv_ioctl, /*expend*/
        },
};
