...
// #define _VHTRGT			0x0460	// 3mA * 750 = 2250mV ->1/2->
// 1125mV
// = 1125mV/1980mV *1024=582d-512d=70d 70d*16=1120
#define _VHTRGT                                                                \
    0x0BA2 // 3mA * 750 = 2250mV ->1/2-> 1125mV = 1125mV/1650mV *1024=698d-512d=
           // 186d  186d*16= 2979 = 0BA3
...
typedef struct {
    ...
    OIS_UWORD gl_HY_OFS;
    OIS_UWORD
    gl_PSTXOF; // RHM_HT 2013.03.21	Change order to adjust EEP ROM map
    OIS_UWORD
    gl_PSTYOF; // RHM_HT 2013.03.21	Change order to adjust EEP ROM map
    OIS_UWORD gl_GX_OFS;
    OIS_UWORD gl_GY_OFS;
    OIS_UWORD gl_KgxHG;
    OIS_UWORD gl_KgyHG;
...
EXT const _FACT_ADJ FADJ_DEF
    ...
    =
        {
            0x01bf, 0x01e3, 0x020a, 0x0120, 0x02ec, 0x0080, 0x007f,
            0xfd40, 0x0460, 0xdb3f, 0xda4a, 0x2d36, 0x268c,

            0x01e3, 0x020a, 0x0000, 0x0000, 0xffce, 0xfffc,
#if 0
	0x0200,	// gl_CURDAT;
	0x0200,	// gl_HALOFS_X;
	0x0200,	// gl_HALOFS_Y;
...
EXT _FACT_ADJ FADJ_MEM
	...
	0x0000,	// gl_KgyH0;		RHM_HT 2013/11/25	Added
            ...
            0x029E, // gl_HX_OFS;
            0x0091, // gl_HY_OFS;
            0x007D, // gl_PSTXOF;		RHM_HT 2013.03.21	Change order to adjust
                    // EEP
                    // ROM map
            0x007F, // gl_PSTYOF;		RHM_HT 2013.03.21	Change order to adjust
                    // EEP
                    // ROM map
            0x00A9, // gl_GX_OFS;
            0x013E, // gl_GY_OFS;
