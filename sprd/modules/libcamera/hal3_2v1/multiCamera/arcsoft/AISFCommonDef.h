...
// For Common defines
enum e_MemoryFlag {
    e_MemoryFlag_Reference = 0, // the m_pPlane data is pointer to other memeory
                                // ,the m_pPlane need not be freed
    e_MemoryFlag_Copied = 1,    // the m_pPlane data is copyied from other other
                                // memory,the m_pPlane need be freed
    e_MemoryFlag_Transfered = 2, // the m_pPlane data is moved from other other
                                 // memory,the m_pPlane need be freed
