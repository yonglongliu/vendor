...
#define VIDEO_FEATURE_SKINSOFTEN_AUTOSKINTONE	0x0
#define VIDEO_FEATURE_FACESLENDER_EYEENLARGE	0x1
#define VIDEO_FEATURE_MAKEUP					0x2

class BeautyShot_Video_Algorithm : public AISF_NS::AISFReferenceInter
{
public:
	/*
	 *The unique ID of the BeautyShot_Video_Algorithm SDK, used in Create_BeautyShot_Video_Algorithm().
	 */
	static const MInt32 CLASSID = 0;
	/*
	 * Initialize the BeautyShot_Video_Algorithm SDK.
	 */
	virtual MRESULT	Init()=0;
	/*
	 * Uninitialize the BeautyShot_Video_Algorithm SDK. MUST correspond with Init().
	 */
	virtual MRESULT	UnInit()=0;

	/*
	 * Get the BeautyShot_Video_Algorithm SDK's version.
	 */
	virtual const MPBASE_Version *GetVersion()=0;


	/*
	 * Set/Get feature level to/from the BeautyShot_Video_Algorithm SDK
	 ...
	 * pFacesIn: The detected faces info of input image. If it is MNull, BeautyShot_Video_Algorithm will detect faces inside.
	 * pFacesOut: The output faces info. If it is MNull, BeautyShot_Video_Algorithm does not output faces info.
	 */
...
/*
 * The function exported by the dynamic so, which is used to create the BeautyShot_Video_Algorithm SDK object.
 * Parameters:
 *   [IN] ClassID : The unique class ID, defined as BeautyShot_Video_Algorithm::CLASSID.
 *   [OUT] ppalgorithm: The BeautyShot_Video_Algorithm SDK object will be created in this function with reference count as 1.
