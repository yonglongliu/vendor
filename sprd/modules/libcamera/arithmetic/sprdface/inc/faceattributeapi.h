...
typedef struct { int x, y; } FAR_POINT;

/* The face information structure */
typedef struct {
    FAR_POINT landmarks[7]; /* The facial landmark points. The sequence is:
...
FARAPI(int)
FarRecognize(FAR_RECOGNIZER_HANDLE hFAR, const FAR_IMAGE *grayImage,
             const FAR_FACEINFO *face, const FAR_OPTION *option,
