...
cmr_s32 isp_u_yuv_postcdn_block(cmr_handle handle, void *param_ptr)
{
	...
	struct isp_u_blocks_info *post_cdn_ptr = NULL;
	...
	post_cdn_ptr = (struct isp_u_blocks_info *)param_ptr;

	param.isp_id = file->isp_id;
	param.scene_id = post_cdn_ptr->scene_id;
	param.sub_block = ISP_BLOCK_POST_CDN;
	param.property = ISP_PRO_POST_CDN_BLOCK;
	param.property_param = post_cdn_ptr->block_info;
