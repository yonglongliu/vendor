...
cmr_s32 isp_u_yrandom_block(cmr_handle handle, void *param_ptr)
{
	...
	struct isp_u_blocks_info *iircnr_ptr = NULL;
	...
	iircnr_ptr = (struct isp_u_blocks_info *)param_ptr;

	param.isp_id = file->isp_id;
	param.scene_id = iircnr_ptr->scene_id;
	param.sub_block = ISP_BLOCK_IIRCNR;
	param.property = ISP_PRO_YRANDOM_BLOCK;
	param.property_param = iircnr_ptr->block_info;
