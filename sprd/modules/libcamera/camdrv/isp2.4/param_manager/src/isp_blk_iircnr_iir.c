...
cmr_u32 _pm_iircnr_iir_convert_param(void *dst_param, cmr_u32 strength_level, cmr_u32 mode_flag, cmr_u32 scene_flag)
{
	...
	if (iir_cnr_param != NULL) {
		...
		dst_ptr->cur.mode = iir_cnr_param[strength_level].iircnr_iir_mode;
		dst_ptr->cur.y_th = iir_cnr_param[strength_level].iircnr_y_th;
		dst_ptr->cur.uv_th = iir_cnr_param[strength_level].iircnr_uv_th;
		dst_ptr->cur.uv_pg_th = iir_cnr_param[strength_level].iircnr_uv_pg_th;
		dst_ptr->cur.uv_dist = iir_cnr_param[strength_level].iircnr_uv_dist;
		dst_ptr->cur.uv_low_thr2 = iir_cnr_param[strength_level].iircnr_uv_low_thr2;
		dst_ptr->cur.uv_low_thr1 = iir_cnr_param[strength_level].iircnr_uv_low_thr1;
		dst_ptr->cur.uv_s_th = iir_cnr_param[strength_level].iircnr_uv_s_th;
		dst_ptr->cur.alpha_low_u = iir_cnr_param[strength_level].iircnr_alpha_low_u;
		dst_ptr->cur.alpha_low_v = iir_cnr_param[strength_level].iircnr_alpha_low_v;
		dst_ptr->cur.uv_high_thr2 = iir_cnr_param[strength_level].iircnr_uv_high_thr2;
		dst_ptr->cur.ymd_u = iir_cnr_param[strength_level].iircnr_ymd_u;
		dst_ptr->cur.ymd_v = iir_cnr_param[strength_level].iircnr_ymd_v;
		dst_ptr->cur.slope = iir_cnr_param[strength_level].iircnr_slope;
		dst_ptr->cur.factor = iir_cnr_param[strength_level].iircnr_middle_factor;
	}
	return rtn;
}
