...
cmr_u32 _pm_cfa_convert_param(void *dst_cfae_param, cmr_u32 strength_level, cmr_u32 mode_flag, cmr_u32 scene_flag)
{
	...
	if (SENSOR_MULTI_MODE_FLAG != dst_ptr->nr_mode_setting) {
		cfae_param = (struct sensor_cfae_level *)(dst_ptr->param_ptr);
	} else {
		cmr_u32 *multi_nr_map_ptr = PNULL;
		multi_nr_map_ptr = (cmr_u32 *) dst_ptr->scene_ptr;
		total_offset_units = _pm_calc_nr_addr_offset(mode_flag, scene_flag, multi_nr_map_ptr);
		cfae_param = (struct sensor_cfae_level *)((cmr_u8 *) dst_ptr->param_ptr + total_offset_units * dst_ptr->level_num * sizeof(struct sensor_cfae_level));

	}
	strength_level = PM_CLIP(strength_level, 0, dst_ptr->level_num - 1);

	if (cfae_param != NULL) {
		dst_ptr->cur.ee_bypass = cfae_param[strength_level].cfa_ee.cfa_ee_bypass;
		dst_ptr->cur.doee_base = cfae_param[strength_level].cfa_ee.doee_base;
		dst_ptr->cur.cfai_ee_saturation_level = cfae_param[strength_level].cfa_ee.cfai_ee_saturation_level;
		dst_ptr->cur.ee_strength_pos = cfae_param[strength_level].cfa_ee.ee_strength_pos;
		dst_ptr->cur.ee_strength_neg = cfae_param[strength_level].cfa_ee.ee_strength_neg;
		dst_ptr->cur.cfai_ee_edge_tr = cfae_param[strength_level].cfa_ee.ee_thr.cfai_ee_edge_tr;
		dst_ptr->cur.cfai_ee_diagonal_tr = cfae_param[strength_level].cfa_ee.ee_thr.cfai_ee_diagonal_tr;
		dst_ptr->cur.cfai_ee_grid_tr = cfae_param[strength_level].cfa_ee.ee_thr.cfai_ee_grid_tr;
		dst_ptr->cur.cfai_doee_clip_tr = cfae_param[strength_level].cfa_ee.ee_thr.cfai_doee_clip_tr;
		dst_ptr->cur.strength_tr_pos = cfae_param[strength_level].cfa_ee.ee_thr.strength_tr_pos;
		dst_ptr->cur.strength_tr_neg = cfae_param[strength_level].cfa_ee.ee_thr.strength_tr_neg;

		dst_ptr->cur.grid_gain = cfae_param[strength_level].cfa_comm.grid_gain;
		dst_ptr->cur.avg_mode = cfae_param[strength_level].cfa_comm.avg_mode;
		dst_ptr->cur.inter_chl_gain = cfae_param[strength_level].cfa_comm.inter_chl_gain;
		dst_ptr->cur.grid_min_tr = cfae_param[strength_level].cfa_comm.grid_min_tr;

		dst_ptr->cur.cfa_uni_dir_intplt_tr = cfae_param[strength_level].cfa_undir.cfa_uni_dir_intplt_tr;
		dst_ptr->cur.cfai_ee_uni_dir_tr = cfae_param[strength_level].cfa_undir.cfai_ee_uni_dir_tr;
		dst_ptr->cur.plt_diff_tr = cfae_param[strength_level].cfa_undir.plt_diff_tr;
