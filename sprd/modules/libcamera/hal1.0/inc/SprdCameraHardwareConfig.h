...
enum { CAMERA_DC_MODE = 0, CAMERA_DV_MODE, CAMERA_DCDV_MODE_MAX };
...
enum { CAMERA_DC_PREVIEW = 0, CAMERA_DV_PREVIEW, CAMERA_PREVIEW_ENV_MAX };
...
const struct str_map wb_map[] = {{"auto", CAMERA_WB_AUTO},
...
const struct str_map effect_map[] = {
    {"none", CAMERA_EFFECT_NONE},         {"mono", CAMERA_EFFECT_MONO},
    {"red", CAMERA_EFFECT_RED},           {"green", CAMERA_EFFECT_GREEN},
    {"blue", CAMERA_EFFECT_BLUE},         {"antique", CAMERA_EFFECT_YELLOW},
    {"negative", CAMERA_EFFECT_NEGATIVE}, {"sepia", CAMERA_EFFECT_SEPIA},
    {"cold", CAMERA_EFFECT_BLUE},         {NULL, 0}};
...
const struct str_map camera_dcdv_mode[] = {
    {"true", CAMERA_DV_MODE}, {"false", CAMERA_DC_MODE}, {NULL, 0}};

const struct str_map zoom_map[] = {
    {"0", CAMERA_ZOOM_1X},   {"1", CAMERA_ZOOM_2X},   {"2", CAMERA_ZOOM_3X},
    {"3", CAMERA_ZOOM_4X},   {"4", CAMERA_ZOOM_5X},   {"5", CAMERA_ZOOM_6X},
    {"6", CAMERA_ZOOM_7X},   {"7", CAMERA_ZOOM_8X},   {"8", CAMERA_ZOOM_9X},
    {"9", CAMERA_ZOOM_10X},  {"10", CAMERA_ZOOM_11X}, {"11", CAMERA_ZOOM_12X},
    {"12", CAMERA_ZOOM_13X}, {"13", CAMERA_ZOOM_14X}, {"14", CAMERA_ZOOM_15X},
    {"15", CAMERA_ZOOM_16X}, {"16", CAMERA_ZOOM_MAX}, {NULL, 0}};

const struct str_map brightness_map[] = {
    {"0", CAMERA_BRIGHTNESS_0}, {"1", CAMERA_BRIGHTNESS_1},
    {"2", CAMERA_BRIGHTNESS_2}, {"3", CAMERA_BRIGHTNESS_3},
    {"4", CAMERA_BRIGHTNESS_4}, {"5", CAMERA_BRIGHTNESS_5},
    {"6", CAMERA_BRIGHTNESS_6}, {NULL, 0}};

const struct str_map sharpness_map[] = {
    {"0", CAMERA_SHARPNESS_0}, {"1", CAMERA_SHARPNESS_1},
    {"2", CAMERA_SHARPNESS_2}, {"3", CAMERA_SHARPNESS_3},
    {"4", CAMERA_SHARPNESS_4}, {"5", CAMERA_SHARPNESS_5},
    {"6", CAMERA_SHARPNESS_6}, {NULL, 0}};
...
const struct str_map iso_map[] = {{"auto", CAMERA_ISO_AUTO},
                                  {"100", CAMERA_ISO_100},
                                  {"200", CAMERA_ISO_200},
                                  {"400", CAMERA_ISO_400},
                                  {"800", CAMERA_ISO_800},
...
const struct str_map contrast_map[] = {
    {"0", CAMERA_CONTRAST_0}, {"1", CAMERA_CONTRAST_1},
    {"2", CAMERA_CONTRAST_2}, {"3", CAMERA_CONTRAST_3},
    {"4", CAMERA_CONTRAST_4}, {"5", CAMERA_CONTRAST_5},
    {"6", CAMERA_CONTRAST_6}, {NULL, 0}};

const struct str_map saturation_map[] = {
    {"0", CAMERA_SATURATION_0}, {"1", CAMERA_SATURATION_1},
    {"2", CAMERA_SATURATION_2}, {"3", CAMERA_SATURATION_3},
    {"4", CAMERA_SATURATION_4}, {"5", CAMERA_SATURATION_5},
    {"6", CAMERA_SATURATION_6}, {NULL, 0}};
...
const struct str_map antibanding_map[] = {{"50hz", CAMERA_ANTIBANDING_50HZ},
...
const struct str_map flash_mode_map[] = {{"on", CAMERA_FLASH_MODE_ON},
                                         {"off", CAMERA_FLASH_MODE_OFF},
                                         {"torch", CAMERA_FLASH_MODE_TORCH},
                                         {"auto", CAMERA_FLASH_MODE_AUTO},
                                         {NULL, 0}};

const struct str_map recording_hint_map[] = {{"false", CAMERA_RECORDING_FALSE},
                                             {"true", CAMERA_RECORDING_TRUE},
                                             {NULL, 0}};

const struct str_map slowmotion_map[] = {{"0", CAMERA_SLOWMOTION_0},
...
const struct str_map previewenv_map[] = {
    {"0", CAMERA_DC_PREVIEW}, {"1", CAMERA_DV_PREVIEW}, {NULL, 0}};
...
struct config_element sprd_front_camera_hardware_config[] = {
    ...
    {"picture-size-values",
     "2880x1920,2576x1932,2048x1536,1600x1200,1280x960,640x480"},
...
/** SPRD: add { */
    ...
    {"auto-exposure-values",
     "frame-average,center-weighted,spot-metering,metering-intelliwt"},
#else
    {"auto-exposure", "0"},
...
struct config_element sprd_back_camera_hardware_config[] = {
    ...
    {"picture-size-values", "5312x3984,4000x3000,3264x2448,2592x1936,2048x1536,"
                            "1600x1200,1280x960,640x480"},
    {"video-picture-size-values",
     "2592x1944,2592x1944,2592x1944,2592x1944,2592x1944"},
#elif defined(CONFIG_CAMERA_SUPPORT_16M)
    {"picture-size-values", "4608x3456,4000x3000,3264x2448,2592x1936,2048x1536,"
                            "1600x1200,1280x960,640x480"},
    {"video-picture-size-values",
     "2592x1944,2592x1944,2592x1944,2592x1944,2592x1944"},
#elif defined(CONFIG_CAMERA_SUPPORT_13M)
    {"picture-size-values", "4128x3096,4000x3000,3264x2448,2592x1936,2048x1536,"
                            "1600x1200,1280x960,640x480"},
    {"video-picture-size-values",
     "2592x1944,2592x1944,2592x1944,2592x1944,2592x1944"},
#elif defined(CONFIG_CAMERA_SUPPORT_8M)
    {"picture-size-values", "3264x2448,3264x1836,2448x2448,2592x1936,2048x1536,"
                            "2048x1152,1600x1200,1280x960,640x480"},
    {"video-picture-size-values",
     "3264x2448,3264x2448,3264x2448,3264x2448,3264x2448"},
#elif defined(CONFIG_CAMERA_SUPPORT_5M)
    {"picture-size-values", "2592x1936,2048x1536,1600x1200,1280x960,640x480"},
    {"video-picture-size-values",
     "2592x1936,2592x1936,2592x1936,2592x1936,2592x1936"},
    ...
    {"video-picture-size-values",
     "1280x960,1280x960,1280x960,1280x960,1280x960"},
#else
    {"picture-size-values",
     "3264x2448,2592x1936,2048x1536,1600x1200,1280x960,640x480"},
    {"video-picture-size-values",
     "1280x960,1280x960,1280x960,1280x960,1280x960"},
#endif
    {"picture-size", "640x480"},
...
#else
    {"preview-size-values",
     "1920x1080,1280x960,1280x720,720x480,640x480,352x288,320x240,176x144"},
    ...
    {"focus-mode-values",
     "auto,macro,continuous-picture,continuous-video,infinity"},
