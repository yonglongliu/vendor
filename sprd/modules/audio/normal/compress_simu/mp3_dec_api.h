/******************************************************************************
 ** File Name:    mp3_dec_api.h                                                   *
 ** Author: *
 ** DATE:         6/2/2016                                                   *
 ** Copyright:    2016 Spreadtrum, Incorporated. All Rights Reserved.         *
 ** Description:  define data structures for mp3 decoder                      *
 *****************************************************************************/
#ifndef _MP3_API_H
#define _MP3_API_H
...
void MP3_ARM_DEC_DecodeFrame(void *,
