...
/* For line-in fm volume */
#define AUDIO_NV_INFO_SET_FM_LINEIN_VOL      15
/* These definitions must be identical with the ones in codec_pga.xml. */
#define FM_LINEIN_VOL_DEV_SHIFT 0
#define FM_LINEIN_VOL_DEV_MASK 0xf
#define FM_LINEIN_VOL_ADC_SHIFT 4
#define FM_LINEIN_VOL_ADC_MASK 0x3f
#define FM_LINEIN_VOL_DG_SHIFT 10
#define FM_LINEIN_VOL_DG_MASK 0x7f
#define I2S_CTL_INF 7
...
typedef struct{
    ...
    struct route_setting *i2s_switch_fm[I2S_CTL_INF];
    struct route_setting *i2s_switch_btcall[I2S_CTL_INF];
    struct route_setting *i2s_switch_ap[I2S_CTL_INF];
    struct route_setting *i2s_switch_pubcp[I2S_CTL_INF];

#ifdef NXP_SMART_PA
    struct route_setting *i2s_switch_ext_codec_ap;
    struct route_setting *i2s_switch_ext_codec_cp;
#endif

    int interrupt_playback_support;

    int mic_default_channel;
}audio_modem_t;
