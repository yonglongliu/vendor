...
static struct iic_unit eCmdInitArray[] = {
  {
    .operate = 0x02, .addr = 0x0F, .val = 0x08, .mask = 0xFF,
  },
};

static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x11, .val = 0x00, .mask = 0xFF,
  },
  {
...
static struct iic_unit eCmdDisableArray[] = {
  {
    .operate = 0x02, .addr = 0x11, .val = 0x80, .mask = 0xFF,
  },
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x14,
  },
...
static struct iic_unit eCmdGetRawDataArray[] = {
  {
    .operate = 0x01, .addr = 0x02, .val = 0x00, .mask = 0xF0,
  },
  {
    .operate = 0x01, .addr = 0x03, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0x04, .val = 0x00, .mask = 0xF0,
  },
  {
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0x10, .val = 0x0B, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x0A, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x09, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x08, .mask = 0xFF,
  },
  {
...
static struct iic_unit eCmdCheckIdArray[] = {
  {
    .operate = 0x03, .addr = 0x00, .val = 0xF8, .mask = 0xFF,
  },
};
