...
#if 0
  1600, 800, 100, 200, 200, 0, 0, 0, 0,
  0, 850, 900, 900, 85, 350, 350, 0, 0,
  0, 0, 25, 30, 40, 45, 55, 50, 50,
#endif
  1600, 800, 100, 200, 200, 0, 0, 0, 0,
  0, 850, 900, 950, 80, 400, 400, 0, 0,
  0, 0, 25, 30, 40, 45, 55, 50, 50, 910,
  0, 0, 0, 1010, 0, 0, 0, 1070
};
...
static prox_cali_t eProxCaliArray[] = {
  {
    ...
    .noise_high_add = 35,
    .noise_low_add = 20,
    .ps_threshold_high_def = 35,
    .ps_threshold_low_def = 20,
    .dyna_cali_threahold = 10,
    .dyna_cali_reduce = 10,
    .value_threshold = 30,
...
static uint32_t fusion_mode = ACC_GYRO_MAG_FUSION;
