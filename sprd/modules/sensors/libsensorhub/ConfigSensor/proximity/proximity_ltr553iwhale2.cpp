...
static struct iic_unit eCmdInitArray[] = {
  ...
  {
    .operate = 0x02, .addr = 0x83, .val = 0x0A, .mask = 0xFF,
  },
  {
...
static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x81, .val = 0x03, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x92, .val = 0x01, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x8F, .val = 0x00, .mask = 0xFF,
  },
};

static struct iic_unit eCmdDisableArray[] = {
  {
    .operate = 0x02, .addr = 0x81, .val = 0x00, .mask = 0xFF,
  },
};

static struct iic_unit eCmdGetRawDataArray[] = {
  {
    .operate = 0x01, .addr = 0x8D, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0x8E, .val = 0x00, .mask = 0xFF,
  },
};
