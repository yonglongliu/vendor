...
static struct iic_unit eCmdInitArray[] = {
  {
    .operate = 0x02, .addr = 0x40, .val = 0xC0, .mask = 0xC0,
  },
  {
    .operate = 0x02, .addr = 0x41, .val = 0x06, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x42, .val = 0x17, .mask = 0xFF,
  },
};

static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x41, .val = 0x40, .mask = 0x40,
  },
  {
...
static struct iic_unit eCmdDisableArray[] = {
  {
    .operate = 0x02, .addr = 0x41, .val = 0x00, .mask = 0x40,
  },
};
...
static struct iic_unit eCmdCheckIdArray[] = {
  {
    .operate = 0x03, .addr = 0x92, .val = 0xe0, .mask = 0xFF,
  },
};
