...
static struct iic_unit eCmdInitArray[] = {
  ...
  /* Set LEDC and PRST */
  {
    .operate = 0x02, .addr = 0x01, .val = 0x30, .mask = 0x3C,
  },
  /* Disable Interrupt */
  {
    .operate = 0x02, .addr = 0x02, .val = 0x08, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x11, .val = 0x03, .mask = 0xFF,
  },
};
...
static struct iic_unit eCmdEnableArray[] = {
  ...
  {
    .operate = 0x02, .addr = 0x01, .val = 0x00, .mask = 0x3C,
  },
  {
    .operate = 0x02, .addr = 0x02, .val = 0xC0, .mask = 0xC0,
  },
  {
    .operate = 0x02, .addr = 0x03, .val = 0x08, .mask = 0x38,
  },
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x42,
  },
...
static struct iic_unit eCmdSetModeArray[] = {
  {
    .operate = 0x02, .addr = 0x02, .val = 0x00, .mask = 0xC0,
  },
  {
    .operate = 0x02, .addr = 0x10, .val = 0x00, .mask = 0xFF,
  },
...
void SensorHubOpcodeRegisterProximity(void) {
  SensorHubOpcodeRegister("proximity", sensorInfoConfigArray, sSensorOpcode);
  return;
}
