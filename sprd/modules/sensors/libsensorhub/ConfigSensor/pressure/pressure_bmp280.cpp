...
static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0xF4, .val = 0xB7, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0xF5, .val = 0x88, .mask = 0xFF,
  }
};

static struct iic_unit eCmdDisableArray[] = {
  {
    .operate = 0x02, .addr = 0xF4, .val = 0x24, .mask = 0xFF,
  },
};

static struct iic_unit eCmdGetRawDataArray[] = {
  {
    .operate = 0x01, .addr = 0xFC, .val = 0x00, .mask = 0xF0,
  },
  {
    .operate = 0x01, .addr = 0xFB, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0xFA, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0xF9, .val = 0x00, .mask = 0xF0,
  },
  {
    .operate = 0x01, .addr = 0xF8, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0xF7, .val = 0x00, .mask = 0xFF,
  },
};
...
static struct iic_unit eCmdGetStatusArray[] = {
  {
    .operate = 0x01, .addr = 0xF3, .val = 0x00, .mask = 0x00,
  },
};
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0xF4, .val = 0x27, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0xF4, .val = 0x4B, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0xF4, .val = 0x6F, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0xF4, .val = 0xA3, .mask = 0xFF,
  },
};
...
static struct iic_unit eCmdCheckIdArray[] = {
  {
    .operate = 0x03, .addr = 0xD0, .val = 0x58, .mask = 0xFF,
  },
};
...
void SensorHubOpcodeRegisterPressure(void) {
  SensorHubOpcodeRegister("pressure", sensorInfoConfigArray, sSensorOpcode);
  return;
}
