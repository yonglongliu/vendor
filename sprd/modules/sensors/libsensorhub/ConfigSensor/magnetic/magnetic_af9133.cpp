...
static struct iic_unit eCmdInitArray[] = {
  ...
  {
    .operate = 0x02, .addr = 0x0B, .val = 0x34, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x13, .val = 0x36, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x22, .val = 0x15, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x32, .val = 0x66, .mask = 0xFF,
  },
  {
...
static struct iic_unit eCmdDisableArray[] = {
  ...
  {
    .operate = 0x04, .addr = 0x00, .val = 0x00, .mask = 0x00,
  },
};
...
static struct iic_unit eCmdCheckIdArray[] = {
  {
    .operate = 0x03, .addr = 0x00, .val = 0x60, .mask = 0xFF,
  },
};
...
static sensor_info_t sensorInfoConfigArray[] = {
  {
    ...
    .ISR_Mode       = 0,
    .GPIO_ISR_Num   = 0,
    .Slave_Addr     = 0x18, /*7-bit address is 0x0C*/
    .Chip_Id        = 0x60,
