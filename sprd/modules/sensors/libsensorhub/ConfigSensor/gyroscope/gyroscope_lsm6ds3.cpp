...
static struct iic_unit eCmdInitArray[] = {
  {
    .operate = 0x02, .addr = 0x19, .val = 0x00, .mask = 0x38,
  },
  {
...
static struct iic_unit eCmdEnableArray[] = {
  ...
  {
    .operate = 0x02, .addr = 0x19, .val = 0x38, .mask = 0x38,
  },
  {
    .operate = 0x02, .addr = 0x11, .val = 0x0C, .mask = 0x0C,
  },
  {
...
static struct iic_unit eCmdGetStatusArray[] = {
  {
    .operate = 0x03, .addr = 0x1E, .val = 0x02, .mask = 0x02,
  },
};
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0x11, .val = 0x50, .mask = 0xF0,
  },
  {
