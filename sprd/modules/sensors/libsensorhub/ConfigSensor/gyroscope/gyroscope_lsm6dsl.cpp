...
static struct iic_unit eCmdInitArray[] = {
  {
	.operate = 0x02, .addr = 0x11, .val = 0x0C, .mask = 0xF0,
  },
  {
    .operate = 0x02, .addr = 0x12, .val = 0x44, .mask = 0xFF,
  },
  {
    .operate = 0x02, .addr = 0x13, .val = 0x10, .mask = 0x10,
  },
  {
    .operate = 0x02, .addr = 0x16, .val = 0x00, .mask = 0x10,
  },
};

static struct iic_unit eCmdEnableArray[] = {
  {
    .operate = 0x02, .addr = 0x13, .val = 0x00, .mask = 0x10,
  },
  {
...
static struct iic_unit eCmdDisableArray[] = {
  {
	.operate = 0x02, .addr = 0x11, .val = 0x00, .mask = 0xF0,
  },
  {
    .operate = 0x02, .addr = 0x13, .val = 0x10, .mask = 0x10,
  },
...
static struct iic_unit eCmdGetRawDataArray[] = {
  ...
  {
    .operate = 0x01, .addr = 0x25, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0x26, .val = 0x00, .mask = 0xFF,
  },
  {
    .operate = 0x01, .addr = 0x27, .val = 0x00, .mask = 0xFF,
  },
};
...
static struct iic_unit eCmdSetRateArray[] = {
  {
    .operate = 0x02, .addr = 0x11, .val = 0x40, .mask = 0xF0,
  },
  {
    .operate = 0x02, .addr = 0x11, .val = 0x30, .mask = 0xF0,
  },
  {
    .operate = 0x02, .addr = 0x11, .val = 0x20, .mask = 0xF0,
  },
  {
    .operate = 0x02, .addr = 0x11, .val = 0x10, .mask = 0xF0,
  },
  {
...
static struct iic_unit eCmdCheckIdArray[] = {
  {
    .operate = 0x03, .addr = 0x0F, .val = 0x6A, .mask = 0xFF,
  },
};
