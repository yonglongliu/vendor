...
class SprdHWComposer : public hwc_composer_device_1_t {
 public:
  ...
  /*
   *  Traversal display device, and find layers which comply with display
   * device.
   ...
   * */
  int getDisplayAttributes(int disp, uint32_t config,
                           const uint32_t *attributes, int32_t *value);
