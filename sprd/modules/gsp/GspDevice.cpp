...
#include "./GspR5P0Plane/GspR5P0PlaneArray.h"
#include "./GspLiteR2P0Plane/GspLiteR2P0PlaneArray.h"
#endif
#ifdef GRALLOC_ROGUE
#include "./GspR4P0Plane/GspR4P0PlaneArray.h"
#endif
#include "gsp_cfg.h"
...
#define GSP_R4P0_NAME "R4P0"
#define GSP_LITE_R1P0_NAME "LITE_R1P0"
#define GSP_R5P0_NAME "R5P0"
...
#endif
  } else if (strcmp(GSP_R5P0_NAME, mCapability.version) == 0) {
#ifndef GRALLOC_ROGUE
    mPlaneArray = new GspR5P0PlaneArray(GSP_ASYNC);
#endif
  } else if (strcmp(GSP_R4P0_NAME, mCapability.version) == 0) {
#ifdef GRALLOC_ROGUE
    mPlaneArray = new GspR4P0PlaneArray(GSP_ASYNC);
#endif
  } else {
