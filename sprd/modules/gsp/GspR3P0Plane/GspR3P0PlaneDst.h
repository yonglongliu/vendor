 ...
 */
#ifndef GSPR3P0PLANE_GSPR3P0PLANEDST_H_
#define GSPR3P0PLANE_GSPR3P0PLANEDST_H_
...
#define R3P0_DST_GSP_MMU_SIZE (16 * 1024 * 1024)

namespace android {

class GspR3P0PlaneDst : public GspR3P0Plane {
 public:
  explicit GspR3P0PlaneDst(bool async, int max_gspmmu_size,
                           int max_gsp_bandwidth);
  virtual ~GspR3P0PlaneDst() {}

  bool adapt(SprdHWLayer **list, int count);

  struct gsp_r3p0_des_layer_user &getConfig();
 ...
 private:
  enum gsp_r3p0_des_layer_format dstFormatConvert(int format);
  ...
  struct gsp_r3p0_des_layer_user mConfig;
...
#endif  // GSPR3P0PLANE_GSPR3P0PLANEDST_H_
