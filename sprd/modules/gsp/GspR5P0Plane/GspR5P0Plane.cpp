...
bool GspR5P0Plane::checkBlending(hwc_layer_1_t *layer) {
  bool result = false;
  ...
  switch (layer->blending) {
    ...
    case HWC_BLENDING_COVERAGE:
      ALOGI_IF(mDebugFlag, "r5p0 support blending flag: 0x%x", layer->blending);
      result = true;
      break;
    default:
...
bool GspR5P0Plane::isVideoLayer(enum gsp_r5p0_osd_layer_format format) {
  ...
  if (format > GSP_R5P0_OSD_FMT_RGB565) result = true;
