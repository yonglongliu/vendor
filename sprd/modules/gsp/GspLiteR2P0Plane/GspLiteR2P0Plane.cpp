...
enum gsp_addr_type GspLiteR2P0Plane::bufTypeConvert(int flag) {
...
bool GspLiteR2P0Plane::checkBlending(hwc_layer_1_t *layer) {
  bool result = false;
...
bool GspLiteR2P0Plane::isVideoLayer(
  ...
  if (format > GSP_LITE_R2P0_OSD_FMT_RGB565) result = true;
