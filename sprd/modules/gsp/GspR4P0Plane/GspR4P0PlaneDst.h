 ...
 */
#ifndef GSPR4P0PLANE_GSPR4P0PLANEDST_H_
#define GSPR4P0PLANE_GSPR4P0PLANEDST_H_
...
#define R4P0_DST_GSP_MMU_SIZE (16 * 1024 * 1024)

namespace android {

class GspR4P0PlaneDst : public GspR4P0Plane {
 public:
  explicit GspR4P0PlaneDst(bool async, int max_gspmmu_size,
                           int max_gsp_bandwidth);
  virtual ~GspR4P0PlaneDst() {}

  bool adapt(SprdHWLayer **list, int count);

  struct gsp_r4p0_des_layer_user &getConfig();
 ...
 private:
  enum gsp_r4p0_des_layer_format dstFormatConvert(int format);
  ...
  void configFBC(bool outIFBC, int format);
  ...
  struct gsp_r4p0_des_layer_user mConfig;
...
#endif  // GSPR4P0PLANE_GSPR4P0PLANEDST_H_
