 ...
 */
#ifndef GSPR4P0PLANE_GSPR4P0PLANEARRAY_H_
#define GSPR4P0PLANE_GSPR4P0PLANEARRAY_H_
...
#define R4P0_MAX_IMG_NUM 2
#define R4P0_MAX_OSD_NUM 4

namespace android {

class GspR4P0PlaneArray : public GspPlaneArray {
 public:
  explicit GspR4P0PlaneArray(bool async);
  virtual ~GspR4P0PlaneArray();
 ...
 private:
  ...
  int rotAdjust(struct gsp_r4p0_cfg_user *cmd_info, SprdHWLayer **LayerList);
  ...
  GspR4P0PlaneImage *mImagePlane[R4P0_IMGL_NUM];
  GspR4P0PlaneOsd *mOsdPlane[R4P0_OSDL_NUM];
  GspR4P0PlaneDst *mDstPlane;

  int mConfigIndex;
  struct gsp_r4p0_cfg_user *mConfigs;

  struct gsp_r4p0_capability mCapability;
...
#endif  // GSPR4P0PLANE_GSPR4P0PLANEARRAY_H_
