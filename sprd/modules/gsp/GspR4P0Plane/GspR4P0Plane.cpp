...
bool GspR4P0Plane::checkBlending(hwc_layer_1_t *layer) {
  bool result = false;
  ...
  switch (layer->blending) {
    ...
    case HWC_BLENDING_COVERAGE:
      ALOGI_IF(mDebugFlag, "r4p0 support blending flag: 0x%x", layer->blending);
      result = true;
      break;
    default:
...
bool GspR4P0Plane::isVideoLayer(enum gsp_r4p0_osd_layer_format format) {
  ...
  if (format > GSP_R4P0_OSD_FMT_RGB565) result = true;
