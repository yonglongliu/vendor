...
public class RadioInteractorCallbackListener {
    ...
    public static final int LISTEN_SWITCH_PRIMARY_CARD = 0x00020000;
    public static final int LISTEN_SIMMGR_SIM_STATUS_CHANGED_EVENT = 0x00040000;
    public static final int LISTEN_RADIO_CAPABILITY_CHANGED_EVENT = 0x00080000;
    public static final int LISTEN_EXPIRE_SIM = 0x00100000;
    ...
    IRadioInteractorCallback mCallback = new IRadioInteractorCallback.Stub() {
        ...
        public void onExpireSimEvent(int info) {
            Message.obtain(mHandler, LISTEN_EXPIRE_SIM, 0, 0, info).sendToTarget();
        }
    };
    ...
    public void onSwitchPrimaryCard(Object object) {
    }
