...
struct Keymaster1CountingWrapper : public keymaster1_device_t {
    Keymaster1CountingWrapper(keymaster1_device_t* device) : device_(device), counter_(0) {
    ...
    static keymaster1_device_t* device(const keymaster1_device_t* dev) {
        Keymaster1CountingWrapper* wrapper =
            reinterpret_cast<Keymaster1CountingWrapper*>(dev->context);
        return wrapper->device_;
    }

    static void increment(const keymaster1_device_t* dev) {
        Keymaster1CountingWrapper* wrapper =
            reinterpret_cast<Keymaster1CountingWrapper*>(dev->context);
        wrapper->counter_++;
    }
    ...
    static int counting_close_device(hw_device_t* dev) {
        keymaster1_device_t* k0_dev = reinterpret_cast<keymaster1_device_t*>(dev);
        increment(k0_dev);
        Keymaster1CountingWrapper* wrapper =
            reinterpret_cast<Keymaster1CountingWrapper*>(k0_dev->context);
        int retval =
    ...
    static int counting_generate_keypair(const struct keymaster1_device* dev,
    ...
    static int counting_import_keypair(const struct keymaster1_device* dev, const uint8_t* key,
    ...
    static int counting_get_keypair_public(const struct keymaster1_device* dev,
    ...
    static int counting_delete_keypair(const struct keymaster1_device* dev, const uint8_t* key_blob,
    ...
    static int counting_delete_all(const struct keymaster1_device* dev) {
        increment(dev);
    ...
    static int counting_sign_data(const struct keymaster1_device* dev, const void* signing_params,
                                  const uint8_t* key_blob, const size_t key_blob_length,
    ...
    static int counting_verify_data(const struct keymaster1_device* dev, const void* signing_params,
                                    const uint8_t* key_blob, const size_t key_blob_length,
