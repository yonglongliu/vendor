...
int enable_sensor();
void draw_menu(menu_list *);
int device_handle_key(int);
int menu_change(menu_list*, int);
...
extern menu_info menu_phone_result_menu[64];
extern menu_info menu_pcba_result_menu[64];
extern menu_info menu_not_suggestion_result_menu[64];
