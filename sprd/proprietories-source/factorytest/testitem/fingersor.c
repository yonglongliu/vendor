...
{
	int ret = RL_NA;
	int re = -1, res = -1, spi = -1, inter = -1, dead = -1, bubble = -1, fin = -1;
	int row = 2;
	void *sprd_handle_fingersor_dl;
	fingersor_dl factory_init;
	fingersor_dl factory_deinit;
	fingersor_dl spi_test;
	fingersor_dl interrupt_test;
	fingersor_dl reset_test;
	fingersor_dl1 deadpixel_test;
	fingersor_dl bubble_test;
	fingersor_dl finger_detect;
	...
	factory_init = (fingersor_dl)dlsym(sprd_handle_fingersor_dl, "factory_init");
	factory_deinit = (fingersor_dl)dlsym(sprd_handle_fingersor_dl, "factory_deinit");
	spi_test = (fingersor_dl)dlsym(sprd_handle_fingersor_dl, "spi_test");
	interrupt_test = (fingersor_dl)dlsym(sprd_handle_fingersor_dl, "interrupt_test");
	reset_test = (fingersor_dl)dlsym(sprd_handle_fingersor_dl, "reset_test");
	deadpixel_test = (fingersor_dl1)dlsym(sprd_handle_fingersor_dl, "deadpixel_test");
	bubble_test = (fingersor_dl)dlsym(sprd_handle_fingersor_dl, "bubble_test");
	finger_detect = (fingersor_dl)dlsym(sprd_handle_fingersor_dl, "finger_detect");
