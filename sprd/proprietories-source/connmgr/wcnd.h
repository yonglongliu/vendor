...
// when an exception of watdog happens, related infor will write to this
// interface
...
#define WCND_CP2_LOG_KEY "persist.sys.armlog.enable"
...
#define MARLIN_IDNENTITY "marlin"
...
int check_if_reset_enable(void);
