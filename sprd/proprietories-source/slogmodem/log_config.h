...
class LogConfig {
 public:
  ...
  SaveDirType cp_log_dir_type() const { return m_cp_log_dir_type; }
 ...
 private:
  ...
  // modem log save path type(slog/ylog/modem_log)
  SaveDirType m_cp_log_dir_type;
