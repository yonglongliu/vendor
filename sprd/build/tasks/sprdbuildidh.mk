...
ifeq ($(strip $(BOARD_LIBVIDEO_2_0_SHARED_LIBRARY)), true)
RELEASE_DIR +=vendor/sprd/proprietories-source/volte_engine/include_ac702
IDH_BUILTS += ${PRODUCT_OUT}/obj/SHARED_LIBRARIES/libvideo_2_0_intermediates/export_includes \
              ${PRODUCT_OUT}/obj/SHARED_LIBRARIES/libvcecamera_intermediates/export_includes
endif

#IDH release for iwhale2/isharkl2
ifeq ($(strip $(TARGET_NO_VMM)), false)
IDH_BUILTS +=${PRODUCT_OUT}/secvm.bin ${PRODUCT_OUT}/mobilevisor.bin ${PRODUCT_OUT}/mvconfig.bin
endif
...
RELEASE_DIR := $(shell echo $(RELEASE_DIR) | sed 's/[[:space:]]/,/g')
