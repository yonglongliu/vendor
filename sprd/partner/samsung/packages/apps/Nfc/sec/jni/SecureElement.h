...
public:
    ...
    **
    *******************************************************************************/
    void notifyConnectivityListeners ();
...
/* START [J14111101_Part3] - pending enable discovery during listen mode */
    /*******************************************************************************
    **
    ** Function:        setIsPeerInListenMode
    **
    ** Description:     Can be used to determine if the SE is activated in listen mode
    **
    ** Returns:         True if the SE is activated in listen mode
...
/* START [160503001J] Configure HCI setting for wired C/E by eSE chip type (Oberthure or Gemalto)*/
    static const UINT8 EVT_SOFT_RESET = 0x11;    //see specification GlobalPlatform ver 0.5
    static const UINT8 EVT_END_OF_APDU_TRANSFER = 0x12;    //see specification GlobalPlatform ver 0.5
/* END [160503001J] Configure HCI setting for wired C/E by eSE chip type (Oberthure or Gemalto)*/
...
/* START [160503001J] Configure HCI setting for wired C/E by eSE chip type (Oberthure or Gemalto)*/
    static const UINT8 APDU_PIPE_0x15 = 0x15;
    static const UINT8 APDU_GATE_0xF0 = 0xF0;
/* END [160503001J] Configure HCI setting for wired C/E by eSE chip type (Oberthure or Gemalto)*/

    static const UINT8 STATIC_PIPE_0x72 = 0x72;
...
/* END [160503001J] Configure HCI setting for wired C/E by eSE chip type (Oberthure or Gemalto)*/
    ...
    *******************************************************************************/
    ...
    /* START [160503001J] Configure HCI setting for wired C/E by eSE chip type (Oberthure or Gemalto)*/
    static void getESEchipTypeCallback (UINT8 event, UINT16 param_len, UINT8* p_param);
    /* END [160503001J] Configure HCI setting for wired C/E by eSE chip type (Oberthure or Gemalto)*/
