...
/* START [160802001] Patch for DTA  T3T test */
#if(NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
extern void rw_t3t_conn_cback (UINT8 conn_id, tNFC_CONN_EVT event, tNFC_CONN *p_data);
#endif
/* END [160802001] Patch for DTA  T3T test */
