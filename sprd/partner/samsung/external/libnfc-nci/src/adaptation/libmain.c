...
static const char* sNfaStorageBin2 = "/nfaStorage2.bin";
#endif
...
/* START [P1604040001] - Support Dual-SIM solution */
#if(NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
extern BOOLEAN nfa_nv_co_read2(UINT8 *pBuffer, UINT16 nbytes, UINT8 block, UINT8 binType)
{
    BOOLEAN ret = TRUE;
    char filename[256], filename2[256];
    ...
    if(binType != 0x02)
        ...
        strncat(filename2, sNfaStorageBin2, sizeof(filename2)-strlen(filename2)-1);
...
/* START [P1604040001] - Support Dual-SIM solution */
#if(NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
extern BOOLEAN nfa_nv_co_write2(const UINT8 *pBuffer, UINT16 nbytes, UINT8 block, UINT8 binType)
{
    BOOLEAN ret = TRUE;
    char filename[256], filename2[256];
