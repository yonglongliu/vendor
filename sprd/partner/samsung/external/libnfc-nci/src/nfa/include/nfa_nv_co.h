...
NFC_API extern BOOLEAN nfa_nv_co_read2 (UINT8 *p_buf, UINT16 nbytes, UINT8 block, UINT8 binType);
NFC_API extern BOOLEAN nfa_nv_co_write2(const UINT8 *pBuffer, UINT16 nbytes, UINT8 block, UINT8 binType);
#endif
