					...
					struct kbase_gpuprops_regdump *regdump)
{
	...
	if ((0 == strncmp(CONFIG_MALI_BOARD_PLATFORM, "sp9850s", 7)) &&
	    (0 != strncmp(CONFIG_MALI_BOARD_PLATFORM, "sp9850ka", 8)))
	{
		if (regdump->shader_present_lo > 0x0003)
		{
			regdump->shader_present_lo = 0x0003;
		}
	}
