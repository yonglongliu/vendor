...
#include "midgard/include/format_chooser.h"
...
static inline int ADP_COMPRESSED(buffer_handle_t h)
{
	...
	if(((private_handle_t*)h)->internal_format &
                (GRALLOC_ARM_INTFMT_AFBC| GRALLOC_ARM_INTFMT_AFBC_SPLITBLK |GRALLOC_ARM_INTFMT_AFBC_WIDEBLK | GRALLOC_ARM_INTFMT_ARM_AFBC_YUV)){
		return 1;
	}else{
		return 0;
	}
