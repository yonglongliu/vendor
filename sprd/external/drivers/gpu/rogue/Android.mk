...
ifeq ($(strip $(TARGET_BUILD_VARIANT)), user)
LOCAL_SRC_FILES :=  usr/bin/rscompiler
else
LOCAL_SRC_FILES :=  debug/bin/rscompiler
endif
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libclangIMG.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MULTILIB := both
ifeq ($(strip $(TARGET_BUILD_VARIANT)), user)
LOCAL_SRC_FILES_32 :=  usr/lib/libclangIMG.so
LOCAL_SRC_FILES_64 :=  usr/lib64/libclangIMG.so
else
LOCAL_SRC_FILES_32 :=  debug/lib/libclangIMG.so
LOCAL_SRC_FILES_64 :=  debug/lib64/libclangIMG.so
endif
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libLLVMIMG.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MULTILIB := both
ifeq ($(strip $(TARGET_BUILD_VARIANT)), user)
LOCAL_SRC_FILES_32 :=  usr/lib/libLLVMIMG.so
LOCAL_SRC_FILES_64 :=  usr/lib64/libLLVMIMG.so
else
LOCAL_SRC_FILES_32 :=  debug/lib/libLLVMIMG.so
LOCAL_SRC_FILES_64 :=  debug/lib64/libLLVMIMG.so
endif
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libPVRRS.sha1.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MULTILIB := both
ifeq ($(strip $(TARGET_BUILD_VARIANT)), user)
LOCAL_SRC_FILES_32 :=  usr/lib/libPVRRS.sha1.so
LOCAL_SRC_FILES_64 :=  usr/lib64/libPVRRS.sha1.so
else
LOCAL_SRC_FILES_32 :=  debug/lib/libPVRRS.sha1.so
LOCAL_SRC_FILES_64 :=  debug/lib64/libPVRRS.sha1.so
endif
include $(BUILD_PREBUILT)
...
LOCAL_MULTILIB := both
ifeq ($(strip $(TARGET_BUILD_VARIANT)), user)
LOCAL_SRC_FILES_32 :=  usr/lib/libPVRRS.so
LOCAL_SRC_FILES_64 :=  usr/lib64/libPVRRS.so
else
LOCAL_SRC_FILES_32 :=  debug/lib/libPVRRS.so
LOCAL_SRC_FILES_64 :=  debug/lib64/libPVRRS.so
endif
include $(BUILD_PREBUILT)
...
LOCAL_MULTILIB := both
ifeq ($(strip $(TARGET_BUILD_VARIANT)), user)
LOCAL_SRC_FILES_32 :=  usr/lib/libufwriter.so
LOCAL_SRC_FILES_64 :=  usr/lib64/libufwriter.so
else
LOCAL_SRC_FILES_32 :=  debug/lib/libufwriter.so
LOCAL_SRC_FILES_64 :=  debug/lib64/libufwriter.so
endif
include $(BUILD_PREBUILT)
