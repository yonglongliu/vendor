...
extern int my_fprint_f(int fd, const char *fmt, ...);
extern int my_fprint_f_tag(int fd, char *tag, const char *fmt, ...);
extern int my_printf(const char *fmt, ...);
extern int my_printf_tag(char *tag, const char *fmt, ...);
...
#if defined(SUPPORT_X86) || defined(SUPPORT_ARM64)
//#define  cacheflush(a,b,c)   asm("wbinvd\n")
#define  cacheflush(a,b,c)
#endif
